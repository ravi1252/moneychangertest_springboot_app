...
/**
 * 
 * Spring boot app by default returns the below json response for all /error response.
 * So, overriding it to make the response unique across the app
 * 
 * {
...
public class ErrorAttributes extends DefaultErrorAttributes {
	...
	public Map<String, Object> getErrorAttributes(WebRequest webRequest, boolean includeStackTrace) {
		...
		resMap.put("status", AppResponseStatus.failure);
